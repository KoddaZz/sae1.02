...
int main() {
    ...
    vector<string> prenoms = {
        ...
        "Timothy", "Mia", "Kenneth", "Abigail", "Jason", "Emily", "Eric", "Ella", "Jeffrey", "Madeline", // "Emily" en double
    ...
    for (unsigned i = 0; i < nombreRegion; i++) {
        ...
        cout << "Nombre de votes blancs : " << nombreVotesBlancParRegions[i] << endl << " " << endl << " =========================================== " << endl << "      NOUVEAU VOTE / NOUVELLE REGION      " << endl << " =========================================== " << endl << " " << endl;
